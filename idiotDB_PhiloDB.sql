...
INSERT INTO `PhiloDB` VALUES (1,'Friedrich Nietzsche',1844,1900,'German',1,'Thus Spoke Zarathustra','The Ubermensch who has achieved the highest level \nof self-realization and is capable of creating his own values and ideals','Schopenhauer, Lange, Heraclitus'),(2,'Socrates',-470,-399,'Greek',2,'None. Passed down by his students, Plato and Xenophon.','I know that I know nothing.','Pre-Socratics, Pythagoras, Protagoras, Anaxagoras, Athenian Society'),(3,'Plato',-428,-347,'Greek',3,'The Republic','emphasizes a hierarchical structure where individuals are divided into distinct classes based on their innate abilities, with philosopher-kings ruling as the guardians and guiding the state towards the pursuit of wisdom, justice, and the common good.','Socrates, Pythagoras, Heraclitus, Parmenides, Sophists, Greek Literature, Democritus'),(4,'Aristotle',-384,-322,'Greek',4,'Nicomachean Ethics','The ultimate purpose of human life is to attain happiness, which is defined as living a life of virtue and fulfilling one\'s potential.','Plato, Socrates, Pre-Socratics, Plato\'s Academy'),(5,'Diogenes',-412,-323,'Greek',5,'None, teachings recorded by his followers','all the artificial growths of society were incompatible with happiness and that morality implies a return to the simplicity of nature.','Antisthenes, Cynics, Socratic'),(6,'Immanuel Kant',1724,1804,'German',6,'Critique of Pure Reason','Introduced the \'Categorical Imperative\', a principle asserting an action is morally right if one can will that everyone should act in the same way.','Rationalism, Empiricism, Wolff, Newton, Hume, Leibniz, Berkeley, Rousseau'),(7,'René Descartes',1596,1650,'French',7,'Meditations on First Philosophy','\'Cogito, ergo sum\' is the foundational element of Western rationalism, asserting that the act of thinking proves one\'s existence.','Aquinas, Scholasticism, Mathematics, Galileo'),(8,'David Hume',1711,1776,'Scottish',8,'A Treatise of Human Nature','Challenged causality by emphasizing our belief in cause and effect arises more from habit than from logical or empirical reasons.','Locke, Newton, Skepticism, Pyrrhonism'),(9,'John Locke',1632,1704,'English',8,'An Essay Concerning Human Understanding','Promoted the idea of \'Tabula rasa\', suggesting the human mind starts as a blank slate, with knowledge arising only from experience.','Bacon, Descartes, Boyle'),(10,'Jean-Jacques Rousseau',1712,1778,'Swiss/French',9,'The Social Contract','Introduced the concept of the \'General will\', arguing that laws are just when they align with the collective will of the people.','Locke, Montesquieu'),(11,'Georg Wilhelm Friedrich Hegel',1770,1831,'German',10,'The Phenomenology of Spirit','Highlighted the \'Hegelian dialectic\', where an idea (thesis) confronts its opposite (antithesis) and resolves in a higher state (synthesis).','Kant, Plato, Aristotle, Christian Theology');
...
-- Dump completed on 2023-07-29 19:05:05
